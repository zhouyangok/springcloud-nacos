...
import com.authentication.service.IAuthenticationService;
...
public class AuthenticationController {
    ...
    public CommonResult decide(@RequestParam String url, @RequestParam String method, HttpServletRequest request) {
        boolean decide = authenticationService.decide(new HttpServletRequestAuthWrapper(request, url, method));
        return CommonResult.success(decide);
    }
}
